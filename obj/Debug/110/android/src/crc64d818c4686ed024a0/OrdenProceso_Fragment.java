...
public class OrdenProceso_Fragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("OrdenTecnica_App.Fragments.OrdenProceso_Fragment, OrdenTecnica_App", OrdenProceso_Fragment.class, __md_methods);
	}


	public OrdenProceso_Fragment ()
	{
		super ();
		if (getClass () == OrdenProceso_Fragment.class)
			mono.android.TypeManager.Activate ("OrdenTecnica_App.Fragments.OrdenProceso_Fragment, OrdenTecnica_App", "", this, new java.lang.Object[] {  });
	}


	public OrdenProceso_Fragment (int p0)
	{
		super (p0);
		if (getClass () == OrdenProceso_Fragment.class)
			mono.android.TypeManager.Activate ("OrdenTecnica_App.Fragments.OrdenProceso_Fragment, OrdenTecnica_App", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
	}
