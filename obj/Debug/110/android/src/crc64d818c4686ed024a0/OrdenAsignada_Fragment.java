...
public class OrdenAsignada_Fragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("OrdenTecnica_App.Fragments.OrdenAsignada_Fragment, OrdenTecnica_App", OrdenAsignada_Fragment.class, __md_methods);
	}


	public OrdenAsignada_Fragment ()
	{
		super ();
		if (getClass () == OrdenAsignada_Fragment.class)
			mono.android.TypeManager.Activate ("OrdenTecnica_App.Fragments.OrdenAsignada_Fragment, OrdenTecnica_App", "", this, new java.lang.Object[] {  });
	}


	public OrdenAsignada_Fragment (int p0)
	{
		super (p0);
		if (getClass () == OrdenAsignada_Fragment.class)
