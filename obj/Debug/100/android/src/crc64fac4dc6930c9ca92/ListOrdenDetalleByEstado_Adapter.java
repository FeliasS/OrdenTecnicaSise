...
public class ListOrdenDetalleByEstado_Adapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("OrdenTecnica_App.ListRecycler.Adapter.ListOrdenDetalleByEstado_Adapter, OrdenTecnica_App", ListOrdenDetalleByEstado_Adapter.class, __md_methods);
	}


	public ListOrdenDetalleByEstado_Adapter ()
	{
		super ();
		if (getClass () == ListOrdenDetalleByEstado_Adapter.class)
			mono.android.TypeManager.Activate ("OrdenTecnica_App.ListRecycler.Adapter.ListOrdenDetalleByEstado_Adapter, OrdenTecnica_App", "", this, new java.lang.Object[] {  });
	}
