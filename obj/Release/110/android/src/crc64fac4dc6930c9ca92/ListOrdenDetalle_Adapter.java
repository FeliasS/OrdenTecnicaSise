...
public class ListOrdenDetalle_Adapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("OrdenTecnica_App.ListRecycler.Adapter.ListOrdenDetalle_Adapter, OrdenTecnica_App", ListOrdenDetalle_Adapter.class, __md_methods);
	}


	public ListOrdenDetalle_Adapter ()
	{
		super ();
		if (getClass () == ListOrdenDetalle_Adapter.class)
			mono.android.TypeManager.Activate ("OrdenTecnica_App.ListRecycler.Adapter.ListOrdenDetalle_Adapter, OrdenTecnica_App", "", this, new java.lang.Object[] {  });
	}
